...
class ExceptionApiController {
    ...
    fun constraintViolationException(e:ConstraintViolationException,req:HttpServletRequest):ResponseEntity<ErrorResponse>{
        // 1. 에러분석
        ...
        val errorResponse = ErrorResponse().apply {
            ...
            this.path = req.requestURI.toString()
    ...
    fun methodArgumentNotValidException(e:MethodArgumentNotValidException,req: HttpServletRequest): ResponseEntity<ErrorResponse> {
        val errors= mutableListOf<Error>()
